...
Revision ID: 2dbb4d950187
Revises: 715bfa9f1355
Create Date: 2025-12-15 00:25:09.377811
...
revision: str = '2dbb4d950187'
down_revision: Union[str, Sequence[str], None] = '715bfa9f1355'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('target_type', sa.Enum('post', 'video', 'comment', name='like_target', schema='linap'), nullable=False),
